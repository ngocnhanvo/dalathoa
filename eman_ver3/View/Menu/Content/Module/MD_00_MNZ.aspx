...
<%=VNN_JQGridver2.get_layout_face() %>
    ...
    function Avariable0() {
        var column_array = ['capmenu','loai_menu'];
        return column_array;
    }
    //--
    ...
    function action_grid0(action, column) {
        if(action == "add")
        {
			if($('#gs_ma_menucha').val() != ''){
				$('#capmenu').val('1');
			}
			
            mokhoa_column('ma_menu');
            mokhoa_column('capmenu');
            mokhoa_column('loai_menu');
            khoa_column('url');
            $('#url').val('');
            $('#ma_menu').val('MN_0'+ $('#capmenu').val() +'_');
        }
        else if(action == 'edit') {
            khoa_column('ma_menu');
            khoa_column('url');
            khoa_column('capmenu');
            khoa_column('loai_menu');
            khoa_column('taomodule');
        }

        if($('#capmenu').val() == '0') {
            if(action == "add") {
                $('#logo').val('images/toolbar2/');
                $('#taomodule').prop('checked', false); 
            }
            khoa_column('ma_menucha');
        }
        else {
            if(action == "add") {
                $('#logo').val('images/Content/nen_module2.png');
                $('#taomodule').prop('checked', true); 
                $('#ma_menucha').val($('#gs_ma_menucha').val());
            }
            mokhoa_column('ma_menucha');
        }
    }
    //--
