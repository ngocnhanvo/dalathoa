...
using DataAcess;
using System.Linq;
public partial class PrintControllers_MD_00_Baocaoketoan_CongNoPhaiThuNhom : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string nameTemp = "[KT] CÔNG NỢ PHẢI THU (Nhóm KHNCC).repx";
    ...
    public String CreateSql(HttpContext context)
    {
        ...
        string sql = $@"
            ...
            select
                ...
                ncc.sochungtu sct,
                format(ncc.ngaychuyen, 'N{fmtDate}') ngaynk,
                ...
                ROW_NUMBER() OVER (
                    PARTITION BY dtkd.ma_dtkd
                    ORDER BY dtkd.ma_dtkd
                ) cr
