...
using DataAcess;
using System.Linq;
public partial class PrintControllers_MD_00_KiemKeKho_PDN_lenhXuatKho : System.Web.UI.Page
{
    ...
    public String CreateSql(HttpContext context)
    {
        ...
        string loaiCT = Helper.arrLoaiCT_LXK[4];
        ...
        string sql = $@"
            ...
            where
                ...
                and isnull(cdvc.sl_demduoc, 0) - isnull(cdvc.sl_sosach, 0) > 0
            order by
	            sp.ma_sanpham
		";
        return sql;
