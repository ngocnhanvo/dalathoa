...
using DataAcess;
using System.Linq;
public partial class PrintControllers_MD_00_DSDHJQGS_DDHKhongCoGiaTri : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string nameTemp = "[KH] Đơn hàng AncoNexx (không giá trị).repx";
        string nameRpt = "Đơn hàng {so_po} (không có giá trị)";
    ...
    public String CreateSql(HttpContext context)
    {
        ...
        var ancoAddress = "3B/2, 1B Hamlet, An Phu Ward, Thuan An Dist., Binh Duong Province, Vietnam";
        ...
        var nexxAddress = "3B/2, 1B Hamlet, An Phu Ward, Thuan An Dist., Binh Duong Province, Vietnam";
