...
public partial class PrintControllers_MD_00_Xuatnoibo_Default : System.Web.UI.Page
{
    ...
    public String CreateSql()
    {
		...
		string sql = string.Format(@"
		select 
		A.ma_vthh, A.ten_vthh, A.dvt, (case when A.soluong > 0 then convert(nvarchar,convert(decimal(18,2),round(A.soluong , 2, 1))) else '' end ) as soluong, 
		(case when A.dongia > 0 then convert(nvarchar,convert(decimal(18,2),round(A.dongia , 2, 1))) else '' end ) as dongia, A.quycach, 
		A.today, A.sochungtu, A.kho, A.dhct, A.ngaychuyen, A.thanhtien
		from (
		select sp.ma_sanpham as ma_vthh, sp.mota_tiengviet as ten_vthh, 
		dvtsp.ten_dvt as dvt, 
		(case when xb.trangthai = 'SOANTHAO' then nknb_cdh.sl_xuat else 0 end) as soluong, 
		(case when xb.trangthai = 'SOANTHAO' then 0 else nknb_cdh.sl_daxuat end) as dongia,
		N'' as quycach, 
		N'{1}' as today, xb.sochungtu as sochungtu, {2} as kho, {3} as dhct, xb.ngaychuyen as ngaychuyen,  nknb_cdh.mota  as thanhtien
		...
		left join ad_department pb on xb.xuatden = pb.md_phongban_id
		where nknb_cdh.md_xuatkhonb_id = '{0}')A where (A.soluong > 0 or A.dongia > 0)  order by A.ma_vthh asc
		", md_xuatkhonb_id, DateTime.Now.ToString("dd-MM-yyyy"), where_exe, where_dhtc);
		//
		return sql;
    }
...
public class rptPhieuXuatKhoNB : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private void InitializeComponent()
    {
        ...
        this.xrTable2.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow2});
        this.xrTable2.SizeF = new System.Drawing.SizeF(770.9999F, 25F);
        ...
        this.ten_vthh.Weight = 0.49870680180900284D;
        // 
        // quycach
        // 
        ...
        this.quycach.Weight = 0.45490312840726643D;
        // 
        // dvt
        // 
        ...
        this.dvt.Weight = 0.21596519375516338D;
        // 
        // soluong
        // 
        ...
        this.soluong.Weight = 0.34877137375612371D;
        // 
        // dongia
        // 
        ...
        this.dongia.Weight = 0.35068663779748349D;
        // 
        // thanhtien
        // 
        ...
        this.thanhtien.Weight = 0.33576955840470318D;
        // 
        // TopMargin
        // 
        ...
        this.ReportFooter.Controls.AddRange(new DevExpress.XtraReports.UI.XRControl[] {
            ...
            this.xrLabel23,
            this.xrLabel18});
        this.ReportFooter.HeightF = 113.7501F;
        this.ReportFooter.Name = "ReportFooter";
        // 
        // xrLabel7
        // 
        this.xrLabel7.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Italic);
        this.xrLabel7.LocationFloat = new DevExpress.Utils.PointFloat(387.8336F, 73.89572F);
        this.xrLabel7.Name = "xrLabel7";
        this.xrLabel7.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel7.SizeF = new System.Drawing.SizeF(127.1667F, 23F);
        ...
        this.xrLabel8.LocationFloat = new DevExpress.Utils.PointFloat(387.8336F, 50.89579F);
        this.xrLabel8.Name = "xrLabel8";
        this.xrLabel8.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel8.SizeF = new System.Drawing.SizeF(127.1667F, 23F);
        this.xrLabel8.StylePriority.UseFont = false;
        this.xrLabel8.StylePriority.UseTextAlignment = false;
        this.xrLabel8.Text = "Quản đốc";
        this.xrLabel8.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        // 
        // xrLabel5
        // 
        this.xrLabel5.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold);
        this.xrLabel5.LocationFloat = new DevExpress.Utils.PointFloat(125.5001F, 50.89579F);
        this.xrLabel5.Multiline = true;
        this.xrLabel5.Name = "xrLabel5";
        this.xrLabel5.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel5.SizeF = new System.Drawing.SizeF(130.7499F, 23F);
        this.xrLabel5.StylePriority.UseFont = false;
        this.xrLabel5.StylePriority.UseTextAlignment = false;
        this.xrLabel5.Text = "Thủ kho";
        this.xrLabel5.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        // 
        // xrLabel6
        // 
        this.xrLabel6.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Italic);
        this.xrLabel6.LocationFloat = new DevExpress.Utils.PointFloat(125.5001F, 73.89572F);
        this.xrLabel6.Name = "xrLabel6";
        this.xrLabel6.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel6.SizeF = new System.Drawing.SizeF(130.7499F, 23F);
        this.xrLabel6.StylePriority.UseFont = false;
        this.xrLabel6.StylePriority.UseTextAlignment = false;
        this.xrLabel6.Text = "(Ký, họ tên)";
        ...
        this.xrTable3.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow3});
        this.xrTable3.SizeF = new System.Drawing.SizeF(770.9999F, 25F);
        ...
        this.xrTableCell13.Weight = 1.508949406273606D;
        // 
        // xrTableCell20
        // 
        ...
        this.xrTableCell20.Weight = 0.21596518837735357D;
        // 
        // sum_soluong
        // 
        ...
        this.sum_soluong.Padding = new DevExpress.XtraPrinting.PaddingInfo(3, 3, 3, 3, 100F);
        this.sum_soluong.StylePriority.UseBorders = false;
        this.sum_soluong.StylePriority.UsePadding = false;
        ...
        this.sum_soluong.Weight = 0.3487713361930696D;
        // 
        // sum_dongia
        // 
        ...
        this.sum_dongia.Padding = new DevExpress.XtraPrinting.PaddingInfo(3, 3, 3, 3, 100F);
        this.sum_dongia.StylePriority.UseBorders = false;
        this.sum_dongia.StylePriority.UsePadding = false;
        ...
        this.sum_dongia.Weight = 0.35068681817872266D;
        // 
        // sum_thanhtien
        // 
        ...
        this.sum_thanhtien.Weight = 0.33576910928426806D;
        // 
        // xrLabel22
        // 
        this.xrLabel22.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold);
        this.xrLabel22.LocationFloat = new DevExpress.Utils.PointFloat(642.1668F, 50.89579F);
        this.xrLabel22.Name = "xrLabel22";
        this.xrLabel22.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel22.SizeF = new System.Drawing.SizeF(128.8333F, 23F);
        ...
        this.xrLabel27.LocationFloat = new DevExpress.Utils.PointFloat(642.1669F, 73.89572F);
        this.xrLabel27.Name = "xrLabel27";
        this.xrLabel27.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel27.SizeF = new System.Drawing.SizeF(128.8331F, 23F);
        ...
        this.xrLabel26.LocationFloat = new DevExpress.Utils.PointFloat(515.0001F, 73.89582F);
        this.xrLabel26.Name = "xrLabel26";
        this.xrLabel26.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel26.SizeF = new System.Drawing.SizeF(127.1667F, 23F);
        ...
        this.xrLabel21.LocationFloat = new DevExpress.Utils.PointFloat(515.0001F, 50.89579F);
        this.xrLabel21.Name = "xrLabel21";
        this.xrLabel21.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel21.SizeF = new System.Drawing.SizeF(127.1667F, 23F);
        ...
        this.xrLabel20.LocationFloat = new DevExpress.Utils.PointFloat(256.25F, 50.89574F);
        this.xrLabel20.Name = "xrLabel20";
        this.xrLabel20.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel20.SizeF = new System.Drawing.SizeF(131.5836F, 23F);
        this.xrLabel20.StylePriority.UseFont = false;
        this.xrLabel20.StylePriority.UseTextAlignment = false;
        this.xrLabel20.Text = "Điều độ-KT";
        this.xrLabel20.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        // 
        // xrLabel25
        // 
        this.xrLabel25.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Italic);
        this.xrLabel25.LocationFloat = new DevExpress.Utils.PointFloat(256.25F, 73.89572F);
        this.xrLabel25.Name = "xrLabel25";
        this.xrLabel25.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel25.SizeF = new System.Drawing.SizeF(131.5836F, 23F);
        ...
        this.xrLabel23.LocationFloat = new DevExpress.Utils.PointFloat(0.0001017253F, 73.89587F);
        this.xrLabel23.Name = "xrLabel23";
        this.xrLabel23.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel23.SizeF = new System.Drawing.SizeF(125.5F, 23F);
        ...
        this.xrLabel18.LocationFloat = new DevExpress.Utils.PointFloat(0.0001017253F, 50.89579F);
        this.xrLabel18.Multiline = true;
        this.xrLabel18.Name = "xrLabel18";
        this.xrLabel18.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel18.SizeF = new System.Drawing.SizeF(125.5F, 23F);
        ...
        this.ngaychuyen.LocationFloat = new DevExpress.Utils.PointFloat(680.5004F, 77.70828F);
        ...
        this.xrLabel1.LocationFloat = new DevExpress.Utils.PointFloat(579.8333F, 77.70828F);
        ...
        this.dhct.LocationFloat = new DevExpress.Utils.PointFloat(0.0001017253F, 100.7083F);
        this.dhct.Multiline = true;
        this.dhct.Name = "dhct";
        this.dhct.Padding = new DevExpress.XtraPrinting.PaddingInfo(3, 3, 3, 3, 100F);
        this.dhct.SizeF = new System.Drawing.SizeF(770.9999F, 23.00002F);
        ...
        this.kho.LocationFloat = new DevExpress.Utils.PointFloat(0F, 123.7083F);
        this.kho.Multiline = true;
        this.kho.Name = "kho";
        this.kho.Padding = new DevExpress.XtraPrinting.PaddingInfo(3, 3, 3, 3, 100F);
        this.kho.SizeF = new System.Drawing.SizeF(771.0001F, 22.99999F);
        ...
        this.today.LocationFloat = new DevExpress.Utils.PointFloat(680.5003F, 54.7083F);
        ...
        // xrLabel4
        // 
        this.xrLabel4.LocationFloat = new DevExpress.Utils.PointFloat(579.8335F, 54.70828F);
        ...
        this.xrLabel3.LocationFloat = new DevExpress.Utils.PointFloat(624.25F, 9.999988F);
        this.xrLabel3.Name = "xrLabel3";
        this.xrLabel3.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.xrLabel3.SizeF = new System.Drawing.SizeF(146.7501F, 37.49999F);
        ...
        this.xrLabel2.SizeF = new System.Drawing.SizeF(411.0835F, 37.49996F);
        this.xrLabel2.StylePriority.UseFont = false;
        this.xrLabel2.StylePriority.UseForeColor = false;
        this.xrLabel2.StylePriority.UseTextAlignment = false;
        this.xrLabel2.Text = "PHIẾU XUẤT KHO BỔ SUNG";
        ...
        this.sochungtu.LocationFloat = new DevExpress.Utils.PointFloat(256.25F, 48.54167F);
        this.sochungtu.Name = "sochungtu";
        this.sochungtu.Padding = new DevExpress.XtraPrinting.PaddingInfo(3, 3, 3, 3, 100F);
        this.sochungtu.SizeF = new System.Drawing.SizeF(284.6666F, 23F);
        ...
        this.xrTable1.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow1});
        this.xrTable1.SizeF = new System.Drawing.SizeF(770.9999F, 22.29166F);
        ...
        this.xrTableCell4.Weight = 0.49932837968439236D;
        // 
        // xrTableCell6
        // 
        this.xrTableCell6.Name = "xrTableCell6";
        this.xrTableCell6.Text = "Quy cách";
        this.xrTableCell6.Weight = 0.45546945408524875D;
        // 
        // xrTableCell3
        // 
        this.xrTableCell3.Name = "xrTableCell3";
        this.xrTableCell3.Text = "ĐVT";
        this.xrTableCell3.Weight = 0.21623404035327279D;
        // 
        // xrTableCell2
        // 
        this.xrTableCell2.Name = "xrTableCell2";
        this.xrTableCell2.Text = "SL dk xuất";
        this.xrTableCell2.Weight = 0.34920552721246056D;
        // 
        // xrTableCell8
        // 
        this.xrTableCell8.Name = "xrTableCell8";
        this.xrTableCell8.Text = "SL thực xuất";
        this.xrTableCell8.Weight = 0.3511232460712409D;
        // 
        // xrTableCell9
        // 
        this.xrTableCell9.Name = "xrTableCell9";
        this.xrTableCell9.Text = "Ghi Chú";
        this.xrTableCell9.Weight = 0.33618762546400438D;
        // 
        // rptPhieuXuatKhoNB
        // 
