...
public partial class PrintControllers_MD_00_BaocaoNVL_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        EntityContext db = new EntityContext();
        SoPhanTichBOM report = new SoPhanTichBOM();
    ...
    public String CreateSql()
    {
		...
		from
		( 
				select (N'PHÂN XƯỞNG: ' + px.ten_phanxuong) as xuong,
					ddhpx.sochungtu as ddhpx,
					ddhpx.donhang_thamchieu as dhtc,
					ddhpx_vt.soluong as sl,
			   ...
			   where (ddhpx.md_trangthai_id = 'HIEULUC' or ddhpx.md_trangthai_id = 'KETTHUC')
				 {0}
				 and ddhpx.ngay_hieuluc >= convert(datetime,N'{1} 00:00',103)
				 and ddhpx.ngay_hieuluc <= convert(datetime,N'{2} 23:59',103) )a
				order by a.ddhpx,
						 a.dhtc,
						 a.ma_sp
...
/// <summary>
/// Summary description for SoPhanTichBOM
/// </summary>
public class SoPhanTichBOM : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private XRTableCell ddhpx;
    private XRTableCell dhtc;
    ...
    private void InitializeComponent()
    {
        ...
        this.ddhpx = new DevExpress.XtraReports.UI.XRTableCell();
        this.dhtc = new DevExpress.XtraReports.UI.XRTableCell();
        ...
        // ddhpx
        // 
        this.ddhpx.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
        this.ddhpx.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "ddhpx")});
        this.ddhpx.Name = "ddhpx";
        this.ddhpx.StylePriority.UseBorders = false;
        this.ddhpx.StylePriority.UseTextAlignment = false;
        this.ddhpx.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.ddhpx.Weight = 0.37505103101867693D;
        // 
        // dhtc
        // 
        this.dhtc.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
        this.dhtc.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "dhtc")});
        this.dhtc.Name = "dhtc";
        this.dhtc.Padding = new DevExpress.XtraPrinting.PaddingInfo(5, 0, 0, 0, 100F);
        this.dhtc.StylePriority.UseBorders = false;
        this.dhtc.StylePriority.UsePadding = false;
        this.dhtc.StylePriority.UseTextAlignment = false;
        this.dhtc.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
        this.dhtc.Weight = 0.3709690482093923D;
        // 
        // ma_sp
        // 
        ...
        // TopMargin
        // 
        this.TopMargin.HeightF = 6.666667F;
        ...
        // BottomMargin
        // 
        this.BottomMargin.HeightF = 21.33331F;
        ...
        this.ReportFooter.Controls.AddRange(new DevExpress.XtraReports.UI.XRControl[] {
            ...
            this.xrLabel8,
            this.xrLabel9});
        this.ReportFooter.HeightF = 46.00002F;
        this.ReportFooter.Name = "ReportFooter";
        // 
        // xrLabel6
        // 
        this.xrLabel6.LocationFloat = new DevExpress.Utils.PointFloat(550.611F, 0F);
        ...
        this.xrLabel7.LocationFloat = new DevExpress.Utils.PointFloat(1.999839F, 23.00002F);
        ...
        this.xrLabel8.LocationFloat = new DevExpress.Utils.PointFloat(267.9998F, 23.00002F);
        ...
        this.xrLabel9.LocationFloat = new DevExpress.Utils.PointFloat(533.9999F, 23.00002F);
        ...
        this.GroupHeader1.HeightF = 62.42854F;
        ...
        | DevExpress.XtraPrinting.BorderSide.Bottom)));
        this.xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(0F, 23.29165F);
        this.xrTable1.Name = "xrTable1";
        this.xrTable1.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow1});
        this.xrTable1.SizeF = new System.Drawing.SizeF(800F, 39.13689F);
        ...
        this.xrTableCell6.Text = "ĐĐHPX";
        this.xrTableCell6.Weight = 0.37505100438320726D;
        // 
        // xrTableCell5
        // 
        ...
        this.xrTableCell5.Text = "ĐHTC";
        this.xrTableCell5.Weight = 0.370969026410245D;
        // 
        // xrTableCell1
        // 
        ...
        this.Bands.AddRange(new DevExpress.XtraReports.UI.Band[] {
            ...
            this.ReportFooter,
            this.GroupHeader1});
        this.Margins = new System.Drawing.Printing.Margins(13, 14, 7, 21);
