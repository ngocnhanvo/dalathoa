        ...
        $.extend(Timepicker.prototype, {
                ...
                if (0 === e.find("div.ui-timepicker-div").length && t.showTimepicker) {
                    ...
                    for (t.timeOnly === !0 && (g.prepend('<div class="ui-widget-header ui-helper-clearfix ui-corner-all"><div class="ui-datepicker-title">' + t.timeOnlyTitle + "</div></div>"), e.find(".ui-datepicker-header, .ui-datepicker-calendar").hide()), c = 0, u = i.units.length; u > c; c++) s = i.units[c], n = s.substr(0, 1).toUpperCase() + s.substr(1), a = null !== t["show" + n] ? t["show" + n] : this.support[s], i[s + "_slider"] = i.control.create(i, g.find(".ui_tpicker_" + s + "_slider"), s, i[s], t[s + "Min"], r[s], t["step" + n]), a && t[s + "Grid"] > 0 && (o = 100 * l[s] * t[s + "Grid"] / (r[s] - t[s + "Min"]), g.find(".ui_tpicker_" + s + " table").css({
                        ...
                        var e = $(this),
                            ...
                            a = t.replace(/[^apm]/gi),
                            r = e.data("for");
                        "hour" === r && (-1 !== a.indexOf("p") && 12 > n ? n += 12 : -1 !== a.indexOf("a") && 12 === n && (n = 0)), i.control.value(i, i[r + "_slider"], s, n), i._onTimeChange(), i._onSelectHandler()
                    }).css({
                        cursor: "pointer",
                        width: 100 / l[s] + "%",
                        textAlign: "center",
            ...
            var s = extendRemove(extendRemove({}, $.timepicker._defaults), i || {}),
                n = (-1 !== e.replace(/\'.*?\'/g, "").indexOf("Z"), function (e, t, i) {
                    ...
                    return s ? (-1 !== l.t && (void 0 === s[l.t] || 0 === s[l.t].length ? (o = "", c.ampm = "") : (o = -1 !== $.inArray(s[l.t].toUpperCase(), $.map(i.amNames, function (e) {
                        return e.toUpperCase()
            ...
            let t = $.datepicker._getInst(e.target),
                i = $.datepicker._get(t, "timepicker");
            ...
            let $this = this;
            let t = $this._getInst($(e)[0]);
            t.dpDiv;
            $this._base_gotoToday(e);
            let i = $this._get(t, "timepicker");
            ...
            if (i) {
                ...
                if (s) {
                    ...
                    return n && s._parseTime($(e).val(), s.timeOnly) && (n.setHours(s.hour, s.minute, s.second, s.millisec), n.setMicroseconds(s.microsec), null != s.timezone && (s.support.timezone || null !== s._defaults.timezone || (s.timezone = -1 * n.getTimezoneOffset()), n = $.timepicker.timezoneAdjust(n, s.timezone))), n
                }
