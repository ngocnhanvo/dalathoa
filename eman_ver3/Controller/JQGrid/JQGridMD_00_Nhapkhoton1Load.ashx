<%@ WebHandler Language="C#" Class="JQGridMD_00_NhapnoiboLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_00_NhapnoiboLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
