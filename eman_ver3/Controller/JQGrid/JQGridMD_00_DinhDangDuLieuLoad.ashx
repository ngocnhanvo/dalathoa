<%@ WebHandler Language="C#" Class="JQGridMD_00_DinhDangDuLieuLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_00_DinhDangDuLieuLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        if (Security.id_taikhoan(context) != "")
        {
            ...
            string id_count = select_sql.Split(new string[] { "as" }, StringSplitOptions.None)[0];
            ...
            string sql = $@"
                ...
                fRoM (
                   ...
                   WHeRe 1=1 
                        {mod_.where_sql} 
                        {where_vaitro} 
                        {Security.test_InjectionSQL(filter, where_ex, where_module_select)}
                   {groupby}
                ) P 
                WHeRe 
                    1=1 {filterP} {whereSE}
