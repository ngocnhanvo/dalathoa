<%@ WebHandler Language="C#" Class="JQGridMD_00_BangGiaJQGSLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_00_BangGiaJQGSLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
