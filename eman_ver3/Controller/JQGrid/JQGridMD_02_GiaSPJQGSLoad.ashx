<%@ WebHandler Language="C#" Class="JQGridMD_02_GiaSPJQGSLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_02_GiaSPJQGSLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
