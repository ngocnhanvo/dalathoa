<%@ WebHandler Language="C#" Class="JQGridMD_01_PhienBangGiaJQGSLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_01_PhienBangGiaJQGSLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
