<%@ WebHandler Language="C#" Class="JQGridMD_01_BienImportLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_01_BienImportLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
