<%@ WebHandler Language="C#" Class="JQGridMD_01_DongMuaHangTatCaLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_01_DongMuaHangTatCaLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        if (Security.id_taikhoan(context) != "")
        {
            ...
            orderby, mod_.from_sql, string.Format(@"and cdmh.c_donmuahang_id = '{0}'", id), 
            filter, id_count, id_sel, where_ex, where_vaitro, where_module_select);
