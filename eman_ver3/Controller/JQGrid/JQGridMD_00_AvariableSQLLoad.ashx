<%@ WebHandler Language="C#" Class="JQGridMD_00_AvariableSQLLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;

public class JQGridMD_00_AvariableSQLLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
