<%@ WebHandler Language="C#" Class="JQGridMD_00_QLSochungtuLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_00_QLSochungtuLoad : IHttpHandler , System.Web.SessionState.IRequiresSessionState {
