<%@ WebHandler Language="C#" Class="JQGridMD_00_DSQuocGiaLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_00_DSQuocGiaLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
