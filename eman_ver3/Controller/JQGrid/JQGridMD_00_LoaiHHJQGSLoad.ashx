<%@ WebHandler Language="C#" Class="JQGridMD_00_LoaiHHJQGSLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_00_LoaiHHJQGSLoad : IHttpHandler , System.Web.SessionState.IRequiresSessionState {
