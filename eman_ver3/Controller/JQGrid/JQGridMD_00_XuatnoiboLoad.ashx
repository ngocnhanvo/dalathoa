<%@ WebHandler Language="C#" Class="JQGridMD_00_XuatnoiboLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_00_XuatnoiboLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
