<%@ WebHandler Language="C#" Class="JQGridMD_01_VaiTroBoSungLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_01_VaiTroBoSungLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
