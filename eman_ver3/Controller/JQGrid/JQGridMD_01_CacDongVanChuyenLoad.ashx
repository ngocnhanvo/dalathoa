<%@ WebHandler Language="C#" Class="JQGridMD_01_CacDongVanChuyenLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_01_CacDongVanChuyenLoad : IHttpHandler , System.Web.SessionState.IRequiresSessionState {
