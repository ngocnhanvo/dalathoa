<%@ WebHandler Language="C#" Class="JQGridMD_01_LichSuNXKhoLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_01_LichSuNXKhoLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
