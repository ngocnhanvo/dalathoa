<%@ WebHandler Language="C#" Class="JQGridMD_01_DongKhoJQGSLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_01_DongKhoJQGSLoad : IHttpHandler , System.Web.SessionState.IRequiresSessionState {
