<%@ WebHandler Language="C#" Class="JQGridMD_01_ThuemuahangLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_01_ThuemuahangLoad : IHttpHandler , System.Web.SessionState.IRequiresSessionState {
