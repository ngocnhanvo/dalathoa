<%@ WebHandler Language="C#" Class="JQGridMD_00_EditStyleLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_00_EditStyleLoad : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
