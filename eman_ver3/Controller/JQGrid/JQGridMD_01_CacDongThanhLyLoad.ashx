<%@ WebHandler Language="C#" Class="JQGridMD_01_CDHDXuatKLoad" %>
using System;
using System.Web;
using System.Linq;
using DataAcess;
public class JQGridMD_01_CDHDXuatKLoad : IHttpHandler , System.Web.SessionState.IRequiresSessionState {
