...
public class JQGridMD_01_DDSDHModify : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        switch (oper)
        {
            ...
            case "del":
                this.del(context);
                break;
            case "CA01UpdateDDSAncotradingMD01DDSDHJQGS_MD01DongTCDH":
                this.CA01UpdateDDSAncotradingMD01DDSDHJQGS_MD01DongTCDH(context);
                break;
    ...
    public void CA01UpdateDDSAncotradingMD01DDSDHJQGS_MD01DongTCDH(HttpContext context)
    {
    ...
    public void edit(HttpContext context)
    {
        ...
        {
            string id = context.Request.Form["id"];
            string object_ = db.c_dongdsdh.Where(p => p.c_dongdsdh_id == id).Select(s => s.c_dongdsdh_id).Take(1).FirstOrDefault();
            if (object_ == null)
            {
